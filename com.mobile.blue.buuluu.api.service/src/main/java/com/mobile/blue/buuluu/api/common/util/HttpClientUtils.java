package com.mobile.blue.buuluu.api.common.util;
...
public class HttpClientUtils {
	...
	public static String getMethodRequestByHttps(String url) throws Exception {
	...
	public static String postMethodRequestByHttps(String url, Map<String, String> params) throws Exception {
...
//		NlvoJZkLX0iQsNETBldh9LxLByRR9rla5icdfgZNt2hgrCjhLJx+IGsimFj9tbzh
//		String p ="userId=abc&session=accc&acType=0&lang=en_US";
//		p=EncryptionUtil.encrypt(p, EncryptionUtil.DECRYPT_KEY);
//		System.out.println("p="+p);
//		params.put("p", p);
//		System.out.println("result:" + HttpClientUtils.postMethodRequest("http://54.254.207.134:8080/walking_api_webservice/login.do", params));
	}
}
